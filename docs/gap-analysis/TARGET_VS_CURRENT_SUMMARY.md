...
commit: 4bae770b92f46491b7b7c7569a6507f09057ba3d
...
| TEST_INFRA_FAIL | 0 |
| CURRENT_PASS / FAIL | 546 / 1 |
| structured cases | 317 |
...
2. **[P1]** `FEAT-053` → [TEST-U-015 REQ-047~050 FEAT-053/055/056/058 FLOW-010] 第一断点: SyntaxError: Unexpected identifier 'as' （TEST-BRIDGE-TS-001 / RC-TEST-BRIDGE-TS）
...
4. **TEST-BRIDGE-TS-001** — Node 测试桥支持 TS protocol import（Smart HID）（type=TESTABILITY, sev=P1, gaps≈7）
