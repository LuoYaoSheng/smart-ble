...
| — | **视觉 Gate 六态全量（六态×9 页×三端+Apple）** | — | — | — | — | — | — | — | vis1 可达态首轮已落袋（上行 10 张：空态A×3/筛选×2/Error 横幅×1/P010×3/P002×1）；**U-AND HBuilderX 域已打通（20260911-uand-vis1，12 张）**；剩余待：扫描中/设备列表/权限弹窗/连接态页（P003/P005/P006）需 BLE 夹具或真机、U-WX 扫描态需元素级驱动方案（或 devtools 真机预览） |
