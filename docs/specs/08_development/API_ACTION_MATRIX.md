...
| ~~P09-04~~ | ~~（推广卡）~~ | **已移除（2026-09-10 · F028）**——更多小程序推广区整链下线 | F028 · R27（失效） | 10_platform §4 推广跳转差异行同日作废 |
...
- ☑ 平台差异仅限 10_platform §4 差异表列出的差异点（扫码/分享/日志导出/生命周期/权限模型/设备发现交互；推广差异行随 F028 于 2026-09-10 移除）
