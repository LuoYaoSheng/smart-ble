...
> **范围口径（2026-09-14 MAC-001 落正）**：本文是 Smart BLE **生态家族**的能力差异全集（12 平台）。其中 `UNI-WX-IOS / UNI-WX-AND`（uni-app 微信小程序）自 2026-09-11 用户裁决起**已从本项目运行目标退役**——矩阵条目仅描述生态能力事实，不代表本项目继续构建或发布微信目标（见 [05_PLATFORM_MATRIX 平台退役记录](../../product-contract/05_PLATFORM_MATRIX.md)）。
