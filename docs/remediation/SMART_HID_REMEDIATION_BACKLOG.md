...
### SMART-HID-WORKFLOW-001

- 状态：**DONE**
- 标题：Smart HID Provisioning Workflow / Profile / Diagnostic
- task_type：SOURCE_FIX
- severity：P1
- root_cause_id：RC-SMART-HID-WORKFLOW
...
- 建议提交信息：`source_fix(smart-hid-workflow-001): Smart HID Provisioning Workflow / Profile / Diagnostic`
...
- Test IDs：—
- First Breakpoint：—
- 依赖：SMART-HID-WORKFLOW-001, TEST-BRIDGE-TS-001
- 解锁：
- 禁止修改（本轮）：apps/uniapp/** (until TP-G3); docs/target-product/**; contracts/target/** product semantics
- 自动化验收：related CURRENT_FAIL → PASS; System/Harness remain 0 FAIL
