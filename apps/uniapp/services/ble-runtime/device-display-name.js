/**
 * BLE 设备显示名解析（纯函数，无 Vue/uni/wx）。
 * 批准链（REQ-013 / FEAT-013）：
 ...
 */
export function extractLocalNameFromAdvertisement(device) {
 ...
 */
export function attachDeviceDisplayName(device) {
