...
| P002 | `pages/hid/index` | Smart HID 方案入口、历史设备 | Tab；→ P003/P004 | 🟡 已实现未验证 |
| P003 | `pages/hid/add` | 六步 Smart HID 配网 | P002；→ P004/P006 | 🟡 已实现未验证 |
| P004 | `pages/hid/detail` | 历史资料与维护动作 | P002/P003；→ P003/P006/P005 | ⚠️ 部分通过（历史与实时混用） |
...
孤儿/弱入口：P006 只能经详情或配网异常进入；P005 的“高级 BLE 调试”在 P004 仅 toast 指引，未携带设备上下文。
