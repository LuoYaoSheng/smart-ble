// PAGE-004 Smart HID 历史 页面目标自动化骨架（TEST-P-004）
...
test.describe('PAGE-004 Smart HID 历史', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(process.env.TARGET_APP_URL ?? 'http://127.0.0.1:5173/pages/hid/history');
  });
