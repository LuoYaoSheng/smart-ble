// PAGE-002 Smart HID 配网 页面目标自动化骨架（TEST-P-002）
...
test.describe('PAGE-002 Smart HID 配网', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(process.env.TARGET_APP_URL ?? 'http://127.0.0.1:5173/pages/hid/add');
  });
